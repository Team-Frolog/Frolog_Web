...
export const questions: Question[] = [
  ...
  {
    number: 'Q2.',
    question: '책을 읽는 동안 가장 많이 하는 생각은 무엇인가요?',
    answers: [
  ...
  {
    number: 'Q3.',
    question: '책을 읽는 동안 주로 어떤 습관이 있나요?',
    answers: [
  ...
  },
  {
    number: 'Q4.',
    question:
      '무심코 들른 서점에서 내 마음을 사로잡은 책, 처음 관심을 가졌던 이유는 무엇인가요?',
    answers: [
  ...
  {
    number: 'Q5.',
    question: '책을 다 읽고 나서 가장 먼저 하는 행동은 무엇인가요?',
    answers: [
      { id: 2, value: '책의 내용을 다시 분석하고 정리합니다!' },
  ...
  {
    number: 'Q6.',
    question: '친구에게 책을 추천할 때 주로 어떤 방식을 사용하나요?',
    answers: [
      {
        id: 3,
