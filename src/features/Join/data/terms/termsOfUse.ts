...
3.&nbsp;&nbsp;회사가 제공하는 서비스의 형태와 기능, 디자인 등은 필요한 경우 변경되거나 중단될 수 있습니다. 회사는 이 경우 개별적인 변경에 대하여 회원에게 사전통지하지 않습니다. 다만, 회원에게 불리한 것으로 판단되는 경우 서비스 내 게시 혹은 전자우편을 통하여 이를 공지합니다.
...
**제13조 [이용 계약 해지 및 환불]**
1.&nbsp;&nbsp;회원이 유료 서비스 이용 계약을 해지하고자 할 경우에는 환불 기간 내에 회원이 이용하는 단말기에서 제공되는 앱스토어 또는 구글플레이의 정책에 따라 서비스 해지 양식을 제출하거나 그 밖에 전화나 기타 회사가 제공하는 방법 (전자우편 등)으로 회사에 해지 신청을 하여야 효력이 발생합니다. 회원의 일방적인 어플리케이션 삭제는 서비스 해지 신청에 해당되지 않습니다.

2.&nbsp;&nbsp;회원의 정당한 해지 또는 환불 신청을 받은 회사는 각 유료 서비스에 명시된 해지 또는 환불 안내에 따라 절차를 이행합니다.

3.&nbsp;&nbsp;회원이 유료 서비스를 중도 해지하는 경우, 환불 금액은 앱스토어 또는 구글플레이의 환불 정책에 따르며 환불수수료와 결제수수료가 공제될 수 있습니다.
