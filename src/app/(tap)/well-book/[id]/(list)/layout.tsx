...
function ReviewMemoLayout({ children, params }: Props) {
  return (
    <>
      ...
      <div className='flex-child-layout tooltip-after relative flex-1 gap-[12px] rounded-t-[20px] bg-green-200 py-[36px] after:-top-[10px] after:border-[16px] after:border-green-200'>
        {children}
      </div>
    </>
  );
