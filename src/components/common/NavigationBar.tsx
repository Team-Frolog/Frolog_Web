...
function NavigationBar() {
  ...
  return (
    <div className='fixed bottom-0 left-[50%] flex h-[80px] w-[450px] translate-x-[-50%] items-center justify-around bg-white px-[20px] pb-[15px] mobile:left-0 mobile:w-full mobile:translate-x-0'>
